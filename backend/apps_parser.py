...
from report_engine import _find_col, city_series, geo_series, program_merge_targets, program_series, read_data_sheet
    ...
    for content in files:
        ...
        for cand in PROG_CANDS:
            ...
            if matched > best_matched:
                best_matched, prog = matched, ps.map(lambda p: merge_target.get(p, p))
        if prog is None:
